 ...
 *      3）、需要给配置中心默认添加一个 数据集（Data Id）  数据集默认名: 当前应用名.properties （gomall-coupon.properties）
 *      4）、在gomall-coupon.properties里添加修改配置
...
@MapperScan("cn.jinterest.coupon.dao")
