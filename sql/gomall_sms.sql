/*
 ...
 Source Schema         : gomall_sms

 Target Server Type    : MySQL
 Target Server Version : 50732
 File Encoding         : 65001

 Date: 16/12/2020 20:39:24
*/
...
CREATE TABLE `sms_coupon_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='优惠券领取历史记录';
...
CREATE TABLE `sms_coupon_spu_category_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='优惠券分类关联';
...
CREATE TABLE `sms_home_subject` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='首页专题表【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】';
...
CREATE TABLE `sms_home_subject_spu` (
  ...
  `sort` int(11) DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='专题商品';
...
CREATE TABLE `sms_member_price` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='商品会员价格';

-- ----------------------------
-- Records of sms_member_price
-- ----------------------------
BEGIN;
INSERT INTO `sms_member_price` VALUES (1, 1, 2, '铜牌会员', 2899.0000, 1);
INSERT INTO `sms_member_price` VALUES (2, 1, 3, '银牌会员', 2799.0000, 1);
COMMIT;
...
CREATE TABLE `sms_seckill_session` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='秒杀活动场次';

-- ----------------------------
-- Records of sms_seckill_session
-- ----------------------------
BEGIN;
INSERT INTO `sms_seckill_session` VALUES (19, '场次一', '2020-12-16 16:15:21', '2020-12-17 00:00:00', 1, '2020-12-16 16:15:25');
INSERT INTO `sms_seckill_session` VALUES (20, '场次二', '2020-12-16 16:17:49', '2020-12-17 00:00:00', 1, '2020-12-16 16:17:56');
COMMIT;
...
CREATE TABLE `sms_seckill_sku_notice` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='秒杀商品通知订阅';
...
CREATE TABLE `sms_seckill_sku_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='秒杀活动商品关联';

-- ----------------------------
-- Records of sms_seckill_sku_relation
-- ----------------------------
BEGIN;
INSERT INTO `sms_seckill_sku_relation` VALUES (18, NULL, 19, 20, 3999, 2, 1, 0);
INSERT INTO `sms_seckill_sku_relation` VALUES (19, NULL, 19, 11, 1, 1, 1, 0);
INSERT INTO `sms_seckill_sku_relation` VALUES (20, NULL, 20, 20, 2999, 10, 1, 0);
INSERT INTO `sms_seckill_sku_relation` VALUES (21, NULL, 20, 11, 1999, 10, 1, 0);
COMMIT;
...
CREATE TABLE `sms_sku_full_reduction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='商品满减信息';

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
BEGIN;
INSERT INTO `sms_sku_full_reduction` VALUES (1, 1, 6000.0000, 200.0000, NULL);
COMMIT;
...
CREATE TABLE `sms_sku_ladder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='商品阶梯价格';

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
BEGIN;
INSERT INTO `sms_sku_ladder` VALUES (1, 1, 3, 1.00, NULL, 1);
COMMIT;
...
CREATE TABLE `sms_spu_bounds` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='商品spu积分设置';

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
BEGIN;
INSERT INTO `sms_spu_bounds` VALUES (1, 5, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (2, 6, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (3, 8, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (4, 9, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (5, 12, 0.0000, 0.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (6, 13, 0.0000, 0.0000, NULL);
COMMIT;
