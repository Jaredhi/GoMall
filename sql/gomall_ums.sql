/*
 ...
 Source Schema         : gomall_ums

 Target Server Type    : MySQL
 Target Server Version : 50732
 File Encoding         : 65001

 Date: 16/12/2020 20:38:36
*/
...
CREATE TABLE `ums_growth_change_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='成长值变化历史记录';
...
CREATE TABLE `ums_integration_change_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='积分变化历史记录';
...
CREATE TABLE `ums_member` (
  ...
  `social_uid` varchar(255) DEFAULT NULL COMMENT '社交用户唯一id',
...
CREATE TABLE `ums_member_collect_spu` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT 'create_time',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='会员收藏的商品';
...
CREATE TABLE `ums_member_collect_subject` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='会员收藏的专题活动';
...
CREATE TABLE `ums_member_level` (
  ...
  `note` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='会员等级';
...
CREATE TABLE `ums_member_receive_address` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='会员收货地址';
