/*
 ...
 Source Schema         : gomall_pms

 Target Server Type    : MySQL
 Target Server Version : 50732
 File Encoding         : 65001

 Date: 16/12/2020 20:39:32
*/
...
CREATE TABLE `pms_attr` (
  ...
  `value_type` tinyint(4) DEFAULT NULL COMMENT '值类型',
  PRIMARY KEY (`attr_id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='商品属性';

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
BEGIN;
INSERT INTO `pms_attr` VALUES (9, '入网型号', 1, 'xxx', 'A2223; A2224', 1, 1, 225, 0, 0);
INSERT INTO `pms_attr` VALUES (10, '上市年份', 1, 'xx', '2019年; 2020年', 1, 1, 225, 0, 0);
INSERT INTO `pms_attr` VALUES (11, '机身长度（mm）', 1, 'xx', '150.9', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (12, '机身厚度（mm）', 1, 'xx', ' 8.3', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (13, '颜色', 0, 'xxx', '黑色;白色', 0, 1, 225, 0, 0);
INSERT INTO `pms_attr` VALUES (14, '内存', 0, 'xxx', '64G;128G;256G', 0, 1, 225, 0, 0);
INSERT INTO `pms_attr` VALUES (15, 'GPU型号', 1, 'xx', 'Mali G76', 1, 1, 225, 0, 1);
INSERT INTO `pms_attr` VALUES (16, 'CPU品牌', 1, 'xx', ' 以官网信息为准;A2223', 1, 1, 225, 0, 1);
COMMIT;
...
CREATE TABLE `pms_attr_attrgroup_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='属性&属性分组关联';

-- ----------------------------
-- Records of pms_attr_attrgroup_relation
-- ----------------------------
BEGIN;
INSERT INTO `pms_attr_attrgroup_relation` VALUES (10, 10, 7, 0);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (11, 11, 8, 0);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (12, 12, 8, 0);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (14, 9, 7, 0);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (15, 15, 9, 0);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (16, 16, 9, 0);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='属性分组';

-- ----------------------------
-- Records of pms_attr_group
-- ----------------------------
BEGIN;
INSERT INTO `pms_attr_group` VALUES (7, '主体', 1, '主体', 'xx', 225);
INSERT INTO `pms_attr_group` VALUES (8, '基本信息', 2, '基本信息', 'xx', 225);
INSERT INTO `pms_attr_group` VALUES (9, '主芯片', 0, '主芯片', 'xx', 225);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='品牌';

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
BEGIN;
INSERT INTO `pms_brand` VALUES (1, 'oppo', 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/0828a935bb-e38a-4eca-8621-097fa1476351_oppo.png', 'oppo', 1, 'o', 1);
INSERT INTO `pms_brand` VALUES (3, '华为', 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08be76195b-4429-43cb-87d1-dd84d8455d6a_huawei.png', 'huawei', 1, 'h', 1);
INSERT INTO `pms_brand` VALUES (4, '小米', 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08bd73ce38-84e3-4320-89a8-8423f5b4939a_xiaomi.png', '小米', 1, 'x', 1);
INSERT INTO `pms_brand` VALUES (5, 'Apple', 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/251a700d76-20b9-4ac6-8599-52d8dbb507c6_apple.png', 'Apple', 1, 'a', 1);
COMMIT;
...
CREATE TABLE `pms_category` (
  ...
  PRIMARY KEY (`cat_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1434 DEFAULT CHARSET=utf8mb4 COMMENT='商品三级分类';
...
INSERT INTO `pms_category` VALUES (22, '电子书刊', 1, 2, 1, 0, 'a', NULL, 0);
...
INSERT INTO `pms_category` VALUES (1433, '测试', 0, 1, 0, 0, 'a', '', NULL);
COMMIT;
...
CREATE TABLE `pms_category_brand_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='品牌分类关联';

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
BEGIN;
INSERT INTO `pms_category_brand_relation` VALUES (1, 1, 225, 'oppo', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (3, 3, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (4, 4, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (5, 5, 225, 'Apple', '手机');
COMMIT;
...
CREATE TABLE `pms_product_attr_value` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='spu属性值';

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
BEGIN;
INSERT INTO `pms_product_attr_value` VALUES (9, 5, 9, '入网型号', 'A2223', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (10, 5, 10, '上市年份', ' 2020年', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (11, 5, 11, '机身长度（mm）', '150.9', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (12, 5, 12, '机身厚度（mm）', ' 8.3', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (13, 6, 9, '入网型号', ' A2224', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (14, 6, 10, '上市年份', '2019年', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (15, 6, 11, '机身长度（mm）', '150.9', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (16, 6, 12, '机身厚度（mm）', ' 8.3', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (17, 9, 9, '入网型号', 'A2223', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (18, 9, 10, '上市年份', '2019年', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (19, 9, 11, '机身长度（mm）', '150.9', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (20, 9, 12, '机身厚度（mm）', ' 8.3', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (21, 12, 9, '入网型号', 'A2223', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (22, 12, 10, '上市年份', ' 2020年', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (23, 12, 11, '机身长度（mm）', '150.9', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (24, 12, 12, '机身厚度（mm）', ' 8.3', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (25, 12, 15, 'GPU型号', 'Mali G76', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (26, 12, 16, 'CPU品牌', ' 以官网信息为准', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (27, 13, 9, '入网型号', 'A2223', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (28, 13, 10, '上市年份', ' 2020年', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (29, 13, 11, '机身长度（mm）', '150.9', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (30, 13, 12, '机身厚度（mm）', ' 8.3', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (31, 13, 15, 'GPU型号', '以官网信息为准', NULL, 0);
INSERT INTO `pms_product_attr_value` VALUES (32, 13, 16, 'CPU品牌', 'A2223', NULL, 0);
COMMIT;
...
CREATE TABLE `pms_sku_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COMMENT='sku图片';

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
BEGIN;
INSERT INTO `pms_sku_images` VALUES (1, 1, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/0c0fe51d-0d8c-493b-81c0-782399bce9d7_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (2, 1, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/8fbba519-3a11-430a-8b51-5dd7c07b65b7_28f296629cca865e.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (3, 2, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/0c0fe51d-0d8c-493b-81c0-782399bce9d7_0d40c24b264aa511.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (4, 2, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/8fbba519-3a11-430a-8b51-5dd7c07b65b7_28f296629cca865e.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (5, 3, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/0c0fe51d-0d8c-493b-81c0-782399bce9d7_0d40c24b264aa511.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (6, 3, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/8a34619c-727e-4ed7-85bb-405771bf7544_1f15cdbcf9e1273c.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (7, 3, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/0710dcbf-cb3c-4d5b-8038-fac7580ddca1_b5c6b23d01dcdf81.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (8, 4, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/0c0fe51d-0d8c-493b-81c0-782399bce9d7_0d40c24b264aa511.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (9, 4, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/8a34619c-727e-4ed7-85bb-405771bf7544_1f15cdbcf9e1273c.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (10, 4, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/0710dcbf-cb3c-4d5b-8038-fac7580ddca1_b5c6b23d01dcdf81.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (11, 5, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/10/c483016f-bfab-4459-8cd7-91b8adab3396_3c24f9cd69534030.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (12, 5, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/10/abb29ed3-22cd-472c-8fdd-c1bd97f1c32d_1f15cdbcf9e1273c.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (13, 6, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/19bdd24e-17c4-4a57-82af-b8643f42cad3_0d40c24b264aa511.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (14, 7, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/19bdd24e-17c4-4a57-82af-b8643f42cad3_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (15, 8, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/19bdd24e-17c4-4a57-82af-b8643f42cad3_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (16, 9, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/7da1a68e-974f-4c11-8fa8-6da54c8aca20_28f296629cca865e.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (17, 10, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/ad33f656-7bd0-41e2-8610-26cd4dd8ce63_28f296629cca865e.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (18, 11, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (19, 12, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (20, 13, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (21, 14, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (22, 15, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (23, 16, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (24, 17, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/31be1289-0ad8-4a76-8f35-92f3e1a60238_5b5e74d0978360a1.jpg', NULL, 0);
INSERT INTO `pms_sku_images` VALUES (25, 18, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/5a4d575c-da33-462b-82bc-a1d651bc9dea_e07b540657023162.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (26, 19, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/5a4d575c-da33-462b-82bc-a1d651bc9dea_e07b540657023162.jpg', NULL, 1);
INSERT INTO `pms_sku_images` VALUES (27, 20, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/5a4d575c-da33-462b-82bc-a1d651bc9dea_e07b540657023162.jpg', NULL, 1);
COMMIT;
...
CREATE TABLE `pms_sku_info` (
  ...
  PRIMARY KEY (`sku_id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='sku信息';

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
BEGIN;
INSERT INTO `pms_sku_info` VALUES (11, 12, '华为 HUAWEI Mate 30 Pro 黑色 64G', NULL, 225, 3, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 30 Pro 黑色 64G', 'xx', 4000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (12, 12, '华为 HUAWEI Mate 30 Pro 黑色 128G', NULL, 225, 3, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 30 Pro 黑色 128G', 'xx', 5000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (13, 12, '华为 HUAWEI Mate 30 Pro 黑色 256G', NULL, 225, 3, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 30 Pro 黑色 256G', 'xx', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (14, 12, '华为 HUAWEI Mate 30 Pro 白色 64G', NULL, 225, 3, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 30 Pro 白色 64G', 'xx', 4000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (15, 12, '华为 HUAWEI Mate 30 Pro 白色 128G', NULL, 225, 3, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 30 Pro 白色 128G', 'xx', 5000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (16, 12, '华为 HUAWEI Mate 30 Pro 白色 256G', NULL, 225, 3, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', '华为 HUAWEI Mate 30 Pro 白色 256G', 'xx', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (17, 13, 'iPhone xr 黑色 64G', NULL, 225, 5, '', 'iPhone xr 黑色 64G', '', 5999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (18, 13, 'iPhone xr 黑色 128G', NULL, 225, 5, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/5a4d575c-da33-462b-82bc-a1d651bc9dea_e07b540657023162.jpg', 'iPhone xr 黑色 128G', '', 6999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (19, 13, 'iPhone xr 白色 64G', NULL, 225, 5, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/5a4d575c-da33-462b-82bc-a1d651bc9dea_e07b540657023162.jpg', 'iPhone xr 白色 64G', '', 5999.0000, 0);
INSERT INTO `pms_sku_info` VALUES (20, 13, 'iPhone xr 白色 128G', NULL, 225, 5, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/5a4d575c-da33-462b-82bc-a1d651bc9dea_e07b540657023162.jpg', 'iPhone xr 白色 128G', '', 6999.0000, 0);
COMMIT;
...
CREATE TABLE `pms_sku_sale_attr_value` (
  ...
  `attr_sort` int(11) DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='sku销售属性&值';

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
BEGIN;
INSERT INTO `pms_sku_sale_attr_value` VALUES (1, 1, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (2, 1, 14, '内存', '64G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (3, 2, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (4, 2, 14, '内存', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (5, 3, 13, '颜色', '翡冷翠', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (6, 3, 14, '内存', '64G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (7, 4, 13, '颜色', '翡冷翠', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (8, 4, 14, '内存', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (9, 5, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (10, 5, 14, '内存', '64G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (11, 6, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (12, 6, 14, '内存', '64G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (13, 7, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (14, 7, 14, '内存', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (15, 8, 13, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (16, 8, 14, '内存', '64G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (17, 9, 13, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (18, 9, 14, '内存', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (19, 10, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (20, 10, 14, '内存', '64G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (21, 11, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (22, 11, 14, '内存', '64G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (23, 12, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (24, 12, 14, '内存', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (25, 13, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (26, 13, 14, '内存', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (27, 14, 13, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (28, 14, 14, '内存', '64G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (29, 15, 13, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (30, 15, 14, '内存', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (31, 16, 13, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (32, 16, 14, '内存', '256G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (33, 17, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (34, 17, 14, '内存', '64G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (35, 18, 13, '颜色', '黑色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (36, 18, 14, '内存', '128G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (37, 19, 13, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (38, 19, 14, '内存', '64G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (39, 20, 13, '颜色', '白色', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (40, 20, 14, '内存', '128G', NULL);
COMMIT;
...
CREATE TABLE `pms_spu_images` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='spu图片';

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
BEGIN;
INSERT INTO `pms_spu_images` VALUES (5, 5, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/0c0fe51d-0d8c-493b-81c0-782399bce9d7_0d40c24b264aa511.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (6, 5, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/8a34619c-727e-4ed7-85bb-405771bf7544_1f15cdbcf9e1273c.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (7, 5, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/8fbba519-3a11-430a-8b51-5dd7c07b65b7_28f296629cca865e.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (8, 5, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/08/0710dcbf-cb3c-4d5b-8038-fac7580ddca1_b5c6b23d01dcdf81.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (9, 6, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/10/c483016f-bfab-4459-8cd7-91b8adab3396_3c24f9cd69534030.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (10, 6, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/10/abb29ed3-22cd-472c-8fdd-c1bd97f1c32d_1f15cdbcf9e1273c.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (14, 8, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/19bdd24e-17c4-4a57-82af-b8643f42cad3_0d40c24b264aa511.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (15, 8, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/7da1a68e-974f-4c11-8fa8-6da54c8aca20_28f296629cca865e.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (16, 8, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/c091f91f-c0f1-4867-8a5a-1cb94f4a2b19_23d9fbb256ea5d4a.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (17, 9, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/ad33f656-7bd0-41e2-8610-26cd4dd8ce63_28f296629cca865e.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (18, 12, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/74edc108-0518-4d59-81e4-027fb61514fe_0d40c24b264aa511.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (19, 12, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/b7c3ad18-7225-4deb-85a3-5c5354a5d15d_28f296629cca865e.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (20, 13, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/5a4d575c-da33-462b-82bc-a1d651bc9dea_e07b540657023162.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (21, 13, NULL, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/31be1289-0ad8-4a76-8f35-92f3e1a60238_5b5e74d0978360a1.jpg', NULL, NULL);
COMMIT;
...
CREATE TABLE `pms_spu_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='spu信息';

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
BEGIN;
INSERT INTO `pms_spu_info` VALUES (12, '华为 HUAWEI Mate 30 Pro', '5G 麒麟990 OLED环幕屏双4000万徕卡电影四摄8GB+256GB青山黛5G全网通游戏手机', 225, 3, 0.2100, 1, '2020-11-25 12:06:13', '2020-11-25 12:07:12');
INSERT INTO `pms_spu_info` VALUES (13, 'iPhone xr', 'xxxxx', 225, 5, 0.1800, 1, '2020-11-25 12:35:12', '2020-11-25 12:35:50');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `pms_spu_info_desc` VALUES (8, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/2e3c95b4-9c61-4b9d-8bc3-79f240d4c98a_73366cc235d68202.jpg,https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/960c01fc-e9b7-4232-8cac-31d1428160fb_b094601548ddcb1b.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (9, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/3d34872a-7bb6-407b-8c27-1a4c633ba24d_28f296629cca865e.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (12, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/8da5bde4-2f0e-467a-870d-3683088c26b6_73366cc235d68202.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (13, 'https://interest-mall.oss-cn-guangzhou.aliyuncs.com/2020/11/25/e9492e3f-a504-443c-8479-3f7786c24eea_f205d9c99a2b4b01.jpg');
COMMIT;
