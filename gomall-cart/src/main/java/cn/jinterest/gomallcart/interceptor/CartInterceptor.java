package cn.jinterest.gomallcart.interceptor;


import cn.jinterest.common.constant.cart.CartConstant;
...
//    ThreadLocal 底层map，key为当前线程,同一线程共享数据
