package cn.jinterest.gomallcart.service.impl;

import cn.jinterest.common.utils.R;
import cn.jinterest.gomallcart.feign.ProductFeignService;
import cn.jinterest.gomallcart.interceptor.CartInterceptor;
import cn.jinterest.gomallcart.service.CartService;
import cn.jinterest.gomallcart.vo.Cart;
import cn.jinterest.gomallcart.vo.CartItem;
import cn.jinterest.gomallcart.vo.SkuInfoVo;
import cn.jinterest.gomallcart.to.UserInfoTo;
...
public class CartServiceImpl implements CartService {
    ...
    private final String CART_PREFIX = "gomall:cart:";
    ...
    public CartItem addToCart(Long skuId, Integer num) throws ExecutionException, InterruptedException {
        ...
        // 根据商品的skuId查询redis中存储的数据库， 并判断商品是否存在于这个购物车
